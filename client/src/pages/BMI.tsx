    ...
    <ContentContainer>
      ...
      <Box mb={3}>
        ...
        <Typography>
          ...
          <Typography component='span' fontWeight={600}> BMI does not diagnose the health of an individual. It is simply a screening tool.</Typography>
        </Typography>
      </Box>
      <Box mb={3}>
        ...
        <Typography>
          ...
          <Typography component='span' fontWeight={600}> Waist circumference does not diagnose the health of an individual either. It is also simply a screening tool.</Typography>
        </Typography>
      </Box>
      <Box mb={3}>
