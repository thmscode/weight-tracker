...
const Metric: React.FC<Props> = ({ value, index }) => {
          ...
          >
            {({ errors, touched }) => (
              <Form className='BMI-form'>
                <Box>
                  <Field label='Height (cm)' id='height' name='height' as={TextField} variant='standard' />
                ...
                <Box>
                  <Field label='Weight (kg)' id='weight' name='weight' as={TextField} variant='standard' />
